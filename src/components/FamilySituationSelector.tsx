...
export const FamilySituationSelector: React.FC<FamilySituationSelectorProps> = ({ value, onChange }) => {
  const familyOptions = [
    { 
      value: 'single', 
      label: 'Vienišas/a', 
  ...
  return (
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-lg font-semibold text-gray-800">Šeimos padėtis</p>
        {selectedOption && (
